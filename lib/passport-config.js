...
const callbackURL = (process.env.NODE_ENV == 'production')?
  'https://serene-springs-96415.herokuapp.com/auth/facebook/callback' :
  'http://localhost:3000/auth/facebook/callback';
  passport.use(new FacebookStrategy({
    // 이 부분을 여러분 Facebook App의 정보로 수정해야 합니다.
    clientID : process.env.FBID || '187856521779204',
    clientSecret : process.env.FB_SECRET || '8298c71915d36dc224f730e500d94ce1',
